...
ground_truth = os.path.join(base_dir, "../datasets/mmr_data", "movies_ratings_100000_test.csv")
mf_test = os.path.join(base_dir, "../datasets/mmr_data/movies/2025-12-16_12-48-37/mf_test_100000_predictions.csv")
