...
ground_truth = os.path.join(base_dir, "../datasets/mmr_data", "books_ratings_5000_test.csv")
mf_test = os.path.join(base_dir, "../datasets/mmr_data/books/2025-12-08_15-14-59/mf_test_5000_predictions.csv")
