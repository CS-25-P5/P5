...
def validate_bpr():
    ...
    prediction_val_dataset.to_csv("data/Prediction_val/BPRnn_ThreeLayers_embed64_lr0001_optimizeradam.csv", index = False)
...
def test_bpr(model, testdataloader, device):
    ...
    prediction_test_dataset.to_csv("data/Prediction_test/BPRnn_ThreeLayers_embed64_lr0001_optimizeradam.csv", index = False)
    return total_loss 
