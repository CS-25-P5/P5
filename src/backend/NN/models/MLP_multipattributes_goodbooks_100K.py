...
def run_program(optim,
    ...
    class TorchDataset(Dataset):
        def __init__(self, dataframe): #dataframe
            ...
            self.books = torch.tensor(dataframe['book_index'].values, dtype=torch.long)
    ...
    class MLP_Model(nn.Module):
        def __init__(self, n_users, n_books, embed_len, genre_length, hidden_layers=None, dropout = 0.5):

            super().__init__()
        
            self.user_embeds = nn.Embedding(n_users, embed_len)
            self.book_embeds = nn.Embedding(n_books, embed_len)
        ...
        def forward(self, uservect, bookvect, book_features): #Shape is (batch_size,1)
            user_embed = self.user_embeds(uservect) #Shape is (batch_size, emb_dimension)
            book_embed = self.book_embeds(bookvect)

            x = torch.cat([user_embed, book_embed, book_features], dim=1)  #[batch, embed_len * 2 + book_feature length]
    ...
    model = MLP_Model(n_users= numberof_users, n_books=numberof_books, 
    ...
    def evaluate_loss(model, dataloader, device):
            ...
            with torch.no_grad():
                for users, books, genres, ratings in dataloader:
                    users = users.to(device)
                    books = books.to(device)
                    genres = genres.to(device)
                    ratings = ratings.to(device)

                    prediction = model(users, books, genres)
    ...
    def training(model, trainloader, validationloader, optimizer, stopearly, epochs, device):
        ...
        for epoch in range(1, epochs + 1):
            ...
            for users, books, genres, ratings in trainloader:
                users = users.to(device)
                books = books.to(device)
                genres = genres.to(device)
                ratings = ratings.to(device)
...
a1 = run_program( 
                ...
                learningrate = 0.001,
                embedding_length = 64,
                prediction_val_save = "data/OUTPUT_datasets/NN/Output_Predictions_val_100K_goodbooks(MLPwithGenres)/NNattr_OneLayer_embed64_lr0001_batch64.csv",
                prediction_test_save = "data/OUTPUT_datasets/NN/Output_Predictions_test_100K_goodbooks(MLPwithGenres)/NNattr_OneLayer_embed64_lr0001_batch64.csv")
...
a2 = run_program( 
                ...
                learningrate = 0.001,
                embedding_length = 32,
                prediction_val_save = "data/OUTPUT_datasets/NN/Output_Predictions_val_100K_goodbooks(MLPwithGenres)/NNattr_OneLayer_embed32_lr0001_batch64.csv",
                prediction_test_save = "data/OUTPUT_datasets/NN/Output_Predictions_test_100K_goodbooks(MLPwithGenres)/NNattr_OneLayer_embed32_lr0001_batch64.csv")
...
a3 = run_program( 
                ...
                learningrate = 0.0003,
                embedding_length = 64,
                prediction_val_save = "data/OUTPUT_datasets/NN/Output_Predictions_val_100K_goodbooks(MLPwithGenres)/NNattr_OneLayer_embed64_lr00003_batch64.csv",
                prediction_test_save = "data/OUTPUT_datasets/NN/Output_Predictions_test_100K_goodbooks(MLPwithGenres)/NNattr_OneLayer_embed64_lr00003_batch64.csv")
...
a4 = run_program( 
                ...
                learningrate = 0.0003,
                embedding_length = 32,
                prediction_val_save = "data/OUTPUT_datasets/NN/Output_Predictions_val_100K_goodbooks(MLPwithGenres)/NNattr_OneLayer_embed32_lr00003_batch64.csv",
                prediction_test_save = "data/OUTPUT_datasets/NN/Output_Predictions_test_100K_goodbooks(MLPwithGenres)/NNattr_OneLayer_embed32_lr00003_batch64.csv")
...
a5 = run_program(
                ...
                learningrate = 0.001,
                embedding_length = 64,
                prediction_val_save = "data/OUTPUT_datasets/NN/Output_Predictions_val_100K_goodbooks(MLPwithGenres)/NNattr_OneLayer_embed64_lr0001_batch128.csv",
                prediction_test_save = "data/OUTPUT_datasets/NN/Output_Predictions_test_100K_goodbooks(MLPwithGenres)/NNattr_OneLayer_embed64_lr0001_batch128.csv")
...
a6 = run_program(
                ...
                learningrate = 0.001,
                embedding_length = 32,
                prediction_val_save = "data/OUTPUT_datasets/NN/Output_Predictions_val_100K_goodbooks(MLPwithGenres)/NNattr_OneLayer_embed32_lr0001_batch128.csv",
                prediction_test_save = "data/OUTPUT_datasets/NN/Output_Predictions_test_100K_goodbooks(MLPwithGenres)/NNattr_OneLayer_embed32_lr0001_batch128.csv")
...
a7 = run_program( 
                ...
                learningrate = 0.0003,
                embedding_length = 64,
                prediction_val_save = "data/OUTPUT_datasets/NN/Output_Predictions_val_100K_goodbooks(MLPwithGenres)/NNattr_OneLayer_embed64_lr00003_batch128.csv",
                prediction_test_save = "data/OUTPUT_datasets/NN/Output_Predictions_test_100K_goodbooks(MLPwithGenres)/NNattr_OneLayer_embed64_lr00003_batch128.csv")
...
a8 =  run_program( 
                ...
                learningrate = 0.0003,
                embedding_length = 32,
                prediction_val_save = "data/OUTPUT_datasets/NN/Output_Predictions_val_100K_goodbooks(MLPwithGenres)/NNattr_OneLayer_embed32_lr00003_batch128.csv",
                prediction_test_save = "data/OUTPUT_datasets/NN/Output_Predictions_test_100K_goodbooks(MLPwithGenres)/NNattr_OneLayer_embed32_lr00003_batch128.csv")
...
b1 = run_program( 
                ...
                learningrate = 0.001,
                embedding_length = 64,
                prediction_val_save = "data/OUTPUT_datasets/NN/Output_Predictions_val_100K_goodbooks(MLPwithGenres)/NNattr_TwoLayers_embed64_lr0001_batch64.csv",
                prediction_test_save = "data/OUTPUT_datasets/NN/Output_Predictions_test_100K_goodbooks(MLPwithGenres)/NNattr_TwoLayers_embed64_lr0001_batch64.csv")
...
b2 = run_program( 
                ...
                learningrate = 0.001,
                embedding_length = 32,
                prediction_val_save = "data/OUTPUT_datasets/NN/Output_Predictions_val_100K_goodbooks(MLPwithGenres)/NNattr_TwoLayers_embed32_lr0001_batch64.csv",
                prediction_test_save = "data/OUTPUT_datasets/NN/Output_Predictions_test_100K_goodbooks(MLPwithGenres)/NNattr_TwoLayers_embed32_lr0001_batch64.csv")
...
b3 = run_program( 
                ...
                learningrate = 0.0003,
                embedding_length = 64,
                prediction_val_save = "data/OUTPUT_datasets/NN/Output_Predictions_val_100K_goodbooks(MLPwithGenres)/NNattr_TwoLayers_embed64_lr00003_batch64.csv",
                prediction_test_save = "data/OUTPUT_datasets/NN/Output_Predictions_test_100K_goodbooks(MLPwithGenres)/NNattr_TwoLayers_embed64_lr00003_batch64.csv")
...
b4 = run_program( 
                ...
                learningrate = 0.0003,
                embedding_length = 32,
                prediction_val_save = "data/OUTPUT_datasets/NN/Output_Predictions_val_100K_goodbooks(MLPwithGenres)/NNattr_TwoLayers_embed32_lr00003_batch64.csv",
                prediction_test_save = "data/OUTPUT_datasets/NN/Output_Predictions_test_100K_goodbooks(MLPwithGenres)/NNattr_TwoLayers_embed32_lr00003_batch64.csv")
...
b5 = run_program(
                ...
                learningrate = 0.001,
                embedding_length = 64,
                prediction_val_save = "data/OUTPUT_datasets/NN/Output_Predictions_val_100K_goodbooks(MLPwithGenres)/NNattr_TwoLayers_embed64_lr0001_batch128.csv",
                prediction_test_save = "data/OUTPUT_datasets/NN/Output_Predictions_test_100K_goodbooks(MLPwithGenres)/NNattr_TwoLayers_embed64_lr0001_batch128.csv")
...
b6 = run_program(
                ...
                learningrate = 0.001,
                embedding_length = 32,
                prediction_val_save = "data/OUTPUT_datasets/NN/Output_Predictions_val_100K_goodbooks(MLPwithGenres)/NNattr_TwoLayers_embed32_lr0001_batch128.csv",
                prediction_test_save = "data/OUTPUT_datasets/NN/Output_Predictions_test_100K_goodbooks(MLPwithGenres)/NNattr_TwoLayers_embed32_lr0001_batch128.csv")
...
b7 = run_program( 
                ...
                learningrate = 0.0003,
                embedding_length = 64,
                prediction_val_save = "data/OUTPUT_datasets/NN/Output_Predictions_val_100K_goodbooks(MLPwithGenres)/NNattr_TwoLayers_embed64_lr00003_batch128.csv",
                prediction_test_save = "data/OUTPUT_datasets/NN/Output_Predictions_test_100K_goodbooks(MLPwithGenres)/NNattr_TwoLayers_embed64_lr00003_batch128.csv")
...
b8 =  run_program( 
                ...
                learningrate = 0.0003,
                embedding_length = 32,
                prediction_val_save = "data/OUTPUT_datasets/NN/Output_Predictions_val_100K_goodbooks(MLPwithGenres)/NNattr_TwoLayers_embed32_lr00003_batch128.csv",
                prediction_test_save = "data/OUTPUT_datasets/NN/Output_Predictions_test_100K_goodbooks(MLPwithGenres)/NNattr_TwoLayers_embed32_lr00003_batch128.csv")
...
c1 = run_program( 
                ...
                learningrate = 0.001,
                embedding_length = 64,
                prediction_val_save = "data/OUTPUT_datasets/NN/Output_Predictions_val_100K_goodbooks(MLPwithGenres)/NNattr_ThreeLayers_embed64_lr0001_batch64.csv",
                prediction_test_save = "data/OUTPUT_datasets/NN/Output_Predictions_test_100K_goodbooks(MLPwithGenres)/NNattr_ThreeLayers_embed64_lr0001_batch64.csv")
...
c2 = run_program( 
                ...
                learningrate = 0.001,
                embedding_length = 32,
                prediction_val_save = "data/OUTPUT_datasets/NN/Output_Predictions_val_100K_goodbooks(MLPwithGenres)/NNattr_ThreeLayers_embed32_lr0001_batch64.csv",
                prediction_test_save = "data/OUTPUT_datasets/NN/Output_Predictions_test_100K_goodbooks(MLPwithGenres)/NNattr_ThreeLayers_embed32_lr0001_batch64.csv")
...
c3 = run_program( 
                ...
                learningrate = 0.0003,
                embedding_length = 64,
                prediction_val_save = "data/OUTPUT_datasets/NN/Output_Predictions_val_100K_goodbooks(MLPwithGenres)/NNattr_ThreeLayers_embed64_lr00003_batch64.csv",
                prediction_test_save = "data/OUTPUT_datasets/NN/Output_Predictions_test_100K_goodbooks(MLPwithGenres)/NNattr_ThreeLayers_embed64_lr00003_batch64.csv")
...
c4 = run_program( 
                ...
                learningrate = 0.0003,
                embedding_length = 32,
                prediction_val_save = "data/OUTPUT_datasets/NN/Output_Predictions_val_100K_goodbooks(MLPwithGenres)/NNattr_ThreeLayers_embed32_lr00003_batch64.csv",
                prediction_test_save = "data/OUTPUT_datasets/NN/Output_Predictions_test_100K_goodbooks(MLPwithGenres)/NNattr_ThreeLayers_embed32_lr00003_batch64.csv")
...
c5 = run_program(
                ...
                learningrate = 0.001,
                embedding_length = 64,
                prediction_val_save = "data/OUTPUT_datasets/NN/Output_Predictions_val_100K_goodbooks(MLPwithGenres)/NNattr_ThreeLayers_embed64_lr0001_batch128.csv",
                prediction_test_save = "data/OUTPUT_datasets/NN/Output_Predictions_test_100K_goodbooks(MLPwithGenres)/NNattr_ThreeLayers_embed64_lr0001_batch128.csv")
...
c6 = run_program(
                ...
                learningrate = 0.001,
                embedding_length = 32,
                prediction_val_save = "data/OUTPUT_datasets/NN/Output_Predictions_val_100K_goodbooks(MLPwithGenres)/NNattr_ThreeLayers_embed32_lr0001_batch128.csv",
                prediction_test_save = "data/OUTPUT_datasets/NN/Output_Predictions_test_100K_goodbooks(MLPwithGenres)/NNattr_ThreeLayers_embed32_lr0001_batch128.csv")
...
c7 = run_program( 
                ...
                learningrate = 0.0003,
                embedding_length = 64,
                prediction_val_save = "data/OUTPUT_datasets/NN/Output_Predictions_val_100K_goodbooks(MLPwithGenres)/NNattr_ThreeLayers_embed64_lr00003_batch128.csv",
                prediction_test_save = "data/OUTPUT_datasets/NN/Output_Predictions_test_100K_goodbooks(MLPwithGenres)/NNattr_ThreeLayers_embed64_lr00003_batch128.csv")
...
c8 =  run_program( 
                ...
                learningrate = 0.0003,
                embedding_length = 32,
                prediction_val_save = "data/OUTPUT_datasets/NN/Output_Predictions_val_100K_goodbooks(MLPwithGenres)/NNattr_ThreeLayers_embed32_lr00003_batch128.csv",
                prediction_test_save = "data/OUTPUT_datasets/NN/Output_Predictions_test_100K_goodbooks(MLPwithGenres)/NNattr_ThreeLayers_embed32_lr00003_batch128.csv")
