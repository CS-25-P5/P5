...
input1 = "data/OUTPUT_datasets/NN/Output_Predictions_test_1M_movies(MLPwithBPR)/TEST_GROUNDTRUTH.csv"
input2 = "data/OUTPUT_datasets/NN/Output_Predictions_test_1M_movies(MLPwithGenres)/TEST_GROUNDTRUTH.csv"
input5 = "data/OUTPUT_datasets/NN/Output_Predictions_test_100K_movies(MLPwithBPR)/TEST_GROUNDTRUTH.csv"
input6 = "data/OUTPUT_datasets/NN/Output_Predictions_test_100K_movies(MLPwithGenres)/TEST_GROUNDTRUTH.csv"


input3 = "data/OUTPUT_datasets/NN/Output_Predictions_test_100K_goodbooks(MLPwithBPR)/TEST_GROUNDTRUTH.csv"
input4 = "data/OUTPUT_datasets/NN/Output_Predictions_test_100K_goodbooks(MLPwithGenres)/TEST_GROUNDTRUTH.csv"
...
def rewrite(input):
    ...
    input_folder = "data/INPUT_FOR_MODEL_RECOMMEND"
...
goodbooks_largefile = pandas.read_csv("data/INPUT_datasets/ratings_5M_goodbooks.csv", nrows=100_000)
goodbooks_largefile.to_csv("data/INPUT_datasets/ratings_100K_goodbooks.csv", index=False)

#STEP1) Make goodbooks and movies genre file

ratings_book = pandas.read_csv("data/INPUT_datasets/ratings_100K_goodbooks.csv") #We have userid, bookid, rating
books_metadata = pandas.read_csv("data/INPUT_datasets/Input_goodbooks_dataset_100K/goodbooks_10k_rating_and_description.csv") #bookid + genres
...
merged_book.to_csv("data/INPUT_datasets/ratingsandgenres_100K_goodbooks.csv", index=False)
...
ratings_data = pandas.read_csv("data/INPUT_datasets/ratings_100K_movies.csv", low_memory=False)
links_data = pandas.read_csv("data/INPUT_datasets/Input_movies_dataset_100K/links.csv", low_memory=False)
movie_data = pandas.read_csv("data/INPUT_datasets/Input_movies_dataset_100K/movies_metadata.csv", low_memory=False)
...
final_dataset.to_csv("data/INPUT_datasets/ratingsandgenres_100K_movies.csv", index=False)



#SPIT DATA 80% - 10% - 10% => Make sure users and movies in test appear in training! Add 10% Groundtruth to each filev

input1= pandas.read_csv("data/INPUT_datasets/ratings_1M_movies.csv")
input2= pandas.read_csv("data/INPUT_datasets/ratingsandgenres_1M_movies.csv")
input3= pandas.read_csv("data/INPUT_datasets/ratings_100K_goodbooks.csv")
input4= pandas.read_csv("data/INPUT_datasets/ratingsandgenres_100K_goodbooks.csv")
input5= pandas.read_csv("data/INPUT_datasets/ratings_100K_movies.csv")


input6= pandas.read_csv("data/INPUT_datasets/ratingsandgenres_100K_movies.csv")
...
#train1, val1, test1 = split_train_val_test(input1, "userId", "movieId", "data/INPUT_TRAIN", "data/INPUT_TEST", "data/INPUT_VAL", "ratings_1M_movies")
#train2, val2, test2 = split_train_val_test(input2, "userId", "movieId", "data/INPUT_TRAIN", "data/INPUT_TEST", "data/INPUT_VAL", "ratingsandgenres_1M_movies")
#train3, val3, test3 = split_train_val_test(input3, "user_id", "itemId", "data/INPUT_TRAIN", "data/INPUT_TEST", "data/INPUT_VAL", "ratings_100K_goodbooks")
#train4, val4, test4 = split_train_val_test(input4, "user_id", "itemId", "data/INPUT_TRAIN", "data/INPUT_TEST", "data/INPUT_VAL", "ratingsandgenres_100K_goodbooks")
#train5, val5, test5 = split_train_val_test(input5, "userId", "movieId", "data/INPUT_TRAIN", "data/INPUT_TEST", "data/INPUT_VAL", "ratings_100K_movies")

train6, val6, test6 = split_train_val_test(input6, "userId", "movieId", "data/INPUT_TRAIN", "data/INPUT_TEST", "data/INPUT_VAL", "ratingsandgenres_100K_movies")


#Pair all users with all items in TEST_groundtruth!

movie1 = "data/INPUT_TEST/ratings_1M_movies_test.csv"
movie2 = "data/INPUT_TEST/ratings_100K_movies_test.csv"

movie3 = "data/INPUT_TEST/ratingsandgenres_1M_movies_test.csv"
movie4 = "data/INPUT_TEST/ratingsandgenres_100K_movies_test.csv"

book1 = "data/INPUT_TEST/ratings_100K_goodbooks_test.csv"
book2 = "data/INPUT_TEST/ratingsandgenres_100K_goodbooks_test.csv"

total1 = "data/INPUT_datasets/ratings_100K_movies.csv"
total2 = "data/INPUT_datasets/ratings_100K_goodbooks.csv"
total3 = "data/INPUT_datasets/ratings_1M_movies.csv"
