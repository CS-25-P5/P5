...
input1 = "data/OUTPUT_datasets/NN/Recommend_test_1M_movies(MLPwithBPR)"
input2 = "data/OUTPUT_datasets/NN/Recommend_test_100K_goodbooks(MLPwithBPR)"
input3 = "data/OUTPUT_datasets/NN/Recommend_test_100K_movies(MLPwithBPR)"
input4 = "data/OUTPUT_datasets/NN/Recommend_test_100K_movies(MLPwithGenres)"
