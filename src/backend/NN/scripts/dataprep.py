...
in1 = "data/INPUT_datasets/Input_movies_dataset_100K/ratings_100K.csv"
savingplacetest1 = "data/OUTPUT_datasets/NN/Output_Predictions_test_100K_movies(MLPwithBPR)"
savingplaceval1 = "data/OUTPUT_datasets/NN/Output_Predictions_val_100K_movies(MLPwithBPR)"


in2 = "data/INPUT_datasets/Input_movies_dataset_1M/ratings_1M.csv"
savingplacetest2 = "data/OUTPUT_datasets/NN/Output_Predictions_test_1M_movies(MLPwithBPR)"
savingplaceval2 = "data/OUTPUT_datasets/NN/Output_Predictions_val_1M_movies(MLPwithBPR)"

in3 = "data/INPUT_datasets/Input_goodbooks_dataset_100K/ratings_100K.csv"
savingplacetest3 = "data/OUTPUT_datasets/NN/Output_Predictions_test_100K_goodbooks(MLPwithBPR)"
savingplaceval3 = "data/OUTPUT_datasets/NN/Output_Predictions_val_100K_goodbooks(MLPwithBPR)"
...
getgroundtruth(in1, "data/OUTPUT_datasets/NN/Output_Predictions_test_100K_movies(MLPwithGenres)", "data/OUTPUT_datasets/NN/Output_Predictions_val_100K_movies(MLPwithGenres)" )
getgroundtruth(in2, "data/OUTPUT_datasets/NN/Output_Predictions_test_1M_movies(MLPwithGenres)", "data/OUTPUT_datasets/NN/Output_Predictions_val_1M_movies(MLPwithGenres)")
getgroundtruth(in3, "data/OUTPUT_datasets/NN/Output_Predictions_test_100K_goodbooks(MLPwithGenres)", "data/OUTPUT_datasets/NN/Output_Predictions_val_100K_goodbooks(MLPwithGenres)")
...
'''
books_100K = pandas.read_csv("data/INPUT_datasets/Input_goodbooks_dataset_100K/ratings_100K.csv")
books_genres = pandas.read_csv("data/INPUT_datasets/Input_goodbooks_dataset_100K/books.csv")
...
###inputs
books_test_dataset = pandas.read_csv("data/OUTPUT_datasets/NN/Output_Predictions_test_100K_goodbooks(MLPwithGenres)/GROUNDTRUTH_alluserandbooks.csv")
books_metadata = pandas.read_csv("data/INPUT_datasets/Input_goodbooks_dataset_100K/books.csv")

movies_test_dataset = pandas.read_csv("data/OUTPUT_datasets/NN/Output_Predictions_test_100K_movies(MLPwithGenres)/GROUNDTRUTH_alluserandmovies.csv")
movies_links = pandas.read_csv("data/INPUT_datasets/Input_movies_dataset_100K/links.csv")
movies_meta = pandas.read_csv("data/INPUT_datasets/Input_movies_dataset_100K/movies_metadata.csv", low_memory=False)
...
merged_books.to_csv("data/OUTPUT_datasets/NN/Recommend_test_100K_goodbooks(MLPwithGenres)/Final_input.csv", index=False)
...
final_dataset.to_csv("data/OUTPUT_datasets/NN/Recommend_test_100K_movies(MLPwithGenres)/Final_input_movies.csv", index=False)
