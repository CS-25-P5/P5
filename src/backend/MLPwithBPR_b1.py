...
def validate_bpr():
    ...
    prediction_val_dataset.to_csv("data/Predictions_val/BPRnn_TwoLayers_embed64_lr0001_optimizeradam.csv", index = False)
    
    #Add 2-3 lines about time and GPU usage:
    with open("data/Predictions_val/BPRnn_TwoLayers_embed64_lr0001_optimizeradam.csv", "a") as file:
        file.write("\n")
...
def test_bpr(model, testdataloader, device):
    ...
    prediction_test_dataset.to_csv("data/Predictions_test/BPRnn_TwoLayers_embed64_lr0001_optimizeradam.csv", index = False)

    with open("data/Predictions_test/BPRnn_TwoLayers_embed64_lr0001_optimizeradam.csv", "a") as file:
        file.write("\n")
