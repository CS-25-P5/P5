...
a1 = run_program( 
                ...
                recommend_output= "data/Recommend_test_100K_movies(MLPwithGenres)/NNgenres_OneLayer_embed64_lr0001_batch64.csv")
...
a2 = run_program( 
                ...
                prediction_test_save = None,
                recommend_input=inputforall,
                recommend_output="data/Recommend_test_100K_movies(MLPwithGenres)/NNgenres_OneLayer_embed32_lr0001_batch64.csv")
...
a3 = run_program( 
                ...
                prediction_test_save = None,
                recommend_input=inputforall,
                recommend_output = "data/Recommend_test_100K_movies(MLPwithGenres)/NNgenres_OneLayer_embed64_lr00003_batch64.csv")
...
a4 = run_program( 
                ...
                prediction_test_save = None,
                recommend_input=inputforall,
                recommend_output = "data/Recommend_test_100K_movies(MLPwithGenres)/NNgenres_OneLayer_embed32_lr00003_batch64.csv")
...
a5 = run_program(
                ...
                prediction_test_save = None,
                recommend_input=inputforall,
                recommend_output = "data/Recommend_test_100K_movies(MLPwithGenres)/NNgenres_OneLayer_embed64_lr0001_batch128.csv")
...
a6 = run_program(
                ...
                prediction_test_save = None,
                recommend_input=inputforall,
                recommend_output = "data/Recommend_test_100K_movies(MLPwithGenres)/NNgenres_OneLayer_embed32_lr0001_batch128.csv")
...
a7 = run_program( 
                ...
                prediction_test_save = None,
                recommend_input=inputforall,
                recommend_output = "data/Recommend_test_100K_movies(MLPwithGenres)/NNgenres_OneLayer_embed64_lr00003_batch128.csv")
...
a8 =  run_program( 
                ...
                prediction_test_save = None,
                recommend_input=inputforall,
                recommend_output = "data/Recommend_test_100K_movies(MLPwithGenres)/NNgenres_OneLayer_embed32_lr00003_batch128.csv")
...
b1 = run_program( 
                ...
                prediction_test_save = None,
                recommend_input=inputforall,
                recommend_output = "data/Recommend_test_100K_movies(MLPwithGenres)/NNgenres_TwoLayers_embed64_lr0001_batch64.csv")
...
b2 = run_program( 
                ...
                prediction_test_save = None,
                recommend_input=inputforall,
                recommend_output = "data/Recommend_test_100K_movies(MLPwithGenres)/NNgenres_TwoLayers_embed32_lr0001_batch64.csv")
...
b3 = run_program( 
                ...
                prediction_test_save = None,
                recommend_input=inputforall,
                recommend_output = "data/Recommend_test_100K_movies(MLPwithGenres)/NNgenres_TwoLayers_embed64_lr00003_batch64.csv")
...
b4 = run_program( 
                ...
                prediction_test_save = None,
                recommend_input=inputforall,
                recommend_output = "data/Recommend_test_100K_movies(MLPwithGenres)/NNgenres_TwoLayers_embed32_lr00003_batch64.csv")
...
b5 = run_program(
                ...
                prediction_test_save = None,
                recommend_input=inputforall,
                recommend_output = "data/Recommend_test_100K_movies(MLPwithGenres)/NNgenres_TwoLayers_embed64_lr0001_batch128.csv")
...
b6 = run_program(
                ...
                prediction_test_save = None,
                recommend_input=inputforall,
                recommend_output = "data/Recommend_test_100K_movies(MLPwithGenres)/NNgenres_TwoLayers_embed32_lr0001_batch128.csv")
...
b7 = run_program( 
                ...
                prediction_test_save = None,
                recommend_input=inputforall,
                recommend_output = "data/Recommend_test_100K_movies(MLPwithGenres)/NNgenres_TwoLayers_embed64_lr00003_batch128.csv")
...
b8 =  run_program( 
                ...
                prediction_test_save = None,
                recommend_input=inputforall,
                recommend_output = "data/Recommend_test_100K_movies(MLPwithGenres)/NNgenres_TwoLayers_embed32_lr00003_batch128.csv")
...
c1 = run_program( 
                ...
                prediction_test_save = None,
                recommend_input=inputforall,
                recommend_output = "data/Recommend_test_100K_movies(MLPwithGenres)/NNgenres_ThreeLayers_embed64_lr0001_batch64.csv")
...
c2 = run_program( 
                ...
                prediction_test_save = None,
                recommend_input=inputforall,
                recommend_output = "data/Recommend_test_100K_movies(MLPwithGenres)/NNgenres_ThreeLayers_embed32_lr0001_batch64.csv")
...
c3 = run_program( 
                ...
                prediction_test_save = None,
                recommend_input=inputforall,
                recommend_output = "data/Recommend_test_100K_movies(MLPwithGenres)/NNgenres_ThreeLayers_embed64_lr00003_batch64.csv")
...
c4 = run_program( 
                ...
                prediction_test_save = None,
                recommend_input=inputforall,
                recommend_output = "data/Recommend_test_100K_movies(MLPwithGenres)/NNgenres_ThreeLayers_embed32_lr00003_batch64.csv")
...
c5 = run_program(
                ...
                prediction_test_save = None,
                recommend_input=inputforall,
                recommend_output = "data/Recommend_test_100K_movies(MLPwithGenres)/NNgenres_ThreeLayers_embed64_lr0001_batch128.csv")
...
c6 = run_program(
                ...
                prediction_test_save = None,
                recommend_input=inputforall,
                recommend_output = "data/Recommend_test_100K_movies(MLPwithGenres)/NNgenres_ThreeLayers_embed32_lr0001_batch128.csv")
...
c7 = run_program( 
                ...
                prediction_test_save = None,
                recommend_input=inputforall,
                recommend_output = "data/Recommend_test_100K_movies(MLPwithGenres)/NNgenres_ThreeLayers_embed64_lr00003_batch128.csv")
...
c8 =  run_program( 
                ...
                prediction_test_save = None,
                recommend_input=inputforall,
                recommend_output = "data/Recommend_test_100K_movies(MLPwithGenres)/NNgenres_ThreeLayers_embed32_lr00003_batch128.csv")
