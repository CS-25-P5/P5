...
a1 = run_program( 
                ...
                learningrate = 0.001,
                embedding_length = 64,
                prediction_val_save = "data/Output_Predictions_val_1M_movies(MLPwithGenres)/NNattr_OneLayer_embed64_lr0001_batch64.csv",
                prediction_test_save = "data/Output_Predictions_test_1M_movies(MLPwithGenres)/NNattr_OneLayer_embed64_lr0001_batch64.csv")
...
a2 = run_program( 
                ...
                learningrate = 0.001,
                embedding_length = 32,
                prediction_val_save = "data/Output_Predictions_val_1M_movies(MLPwithGenres)/NNattr_OneLayer_embed32_lr0001_batch64.csv",
                prediction_test_save = "data/Output_Predictions_test_1M_movies(MLPwithGenres)/NNattr_OneLayer_embed32_lr0001_batch64.csv")
...
a3 = run_program( 
                ...
                learningrate = 0.0003,
                embedding_length = 64,
                prediction_val_save = "data/Output_Predictions_val_1M_movies(MLPwithGenres)/NNattr_OneLayer_embed64_lr00003_batch64.csv",
                prediction_test_save = "data/Output_Predictions_test_1M_movies(MLPwithGenres)/NNattr_OneLayer_embed64_lr00003_batch64.csv")
...
a4 = run_program( 
                ...
                learningrate = 0.0003,
                embedding_length = 32,
                prediction_val_save = "data/Output_Predictions_val_1M_movies(MLPwithGenres)/NNattr_OneLayer_embed32_lr00003_batch64.csv",
                prediction_test_save = "data/Output_Predictions_test_1M_movies(MLPwithGenres)/NNattr_OneLayer_embed32_lr00003_batch64.csv")
...
a5 = run_program(
                ...
                learningrate = 0.001,
                embedding_length = 64,
                prediction_val_save = "data/Output_Predictions_val_1M_movies(MLPwithGenres)/NNattr_OneLayer_embed64_lr0001_batch128.csv",
                prediction_test_save = "data/Output_Predictions_test_1M_movies(MLPwithGenres)/NNattr_OneLayer_embed64_lr0001_batch128.csv")
...
a6 = run_program(
                ...
                learningrate = 0.001,
                embedding_length = 32,
                prediction_val_save = "data/Output_Predictions_val_1M_movies(MLPwithGenres)/NNattr_OneLayer_embed32_lr0001_batch128.csv",
                prediction_test_save = "data/Output_Predictions_test_1M_movies(MLPwithGenres)/NNattr_OneLayer_embed32_lr0001_batch128.csv")
...
a7 = run_program( 
                ...
                learningrate = 0.0003,
                embedding_length = 64,
                prediction_val_save = "data/Output_Predictions_val_1M_movies(MLPwithGenres)/NNattr_OneLayer_embed64_lr00003_batch128.csv",
                prediction_test_save = "data/Output_Predictions_test_1M_movies(MLPwithGenres)/NNattr_OneLayer_embed64_lr00003_batch128.csv")
...
a8 =  run_program( 
                ...
                learningrate = 0.0003,
                embedding_length = 32,
                prediction_val_save = "data/Output_Predictions_val_1M_movies(MLPwithGenres)/NNattr_OneLayer_embed32_lr00003_batch128.csv",
                prediction_test_save = "data/Output_Predictions_test_1M_movies(MLPwithGenres)/NNattr_OneLayer_embed32_lr00003_batch128.csv")
...
b1 = run_program( 
                ...
                learningrate = 0.001,
                embedding_length = 64,
                prediction_val_save = "data/Output_Predictions_val_1M_movies(MLPwithGenres)/NNattr_TwoLayers_embed64_lr0001_batch64.csv",
                prediction_test_save = "data/Output_Predictions_test_1M_movies(MLPwithGenres)/NNattr_TwoLayers_embed64_lr0001_batch64.csv")
...
b2 = run_program( 
                ...
                learningrate = 0.001,
                embedding_length = 32,
                prediction_val_save = "data/Output_Predictions_val_1M_movies(MLPwithGenres)/NNattr_TwoLayers_embed32_lr0001_batch64.csv",
                prediction_test_save = "data/Output_Predictions_test_1M_movies(MLPwithGenres)/NNattr_TwoLayers_embed32_lr0001_batch64.csv")
...
b3 = run_program( 
                ...
                learningrate = 0.0003,
                embedding_length = 64,
                prediction_val_save = "data/Output_Predictions_val_1M_movies(MLPwithGenres)/NNattr_TwoLayers_embed64_lr00003_batch64.csv",
                prediction_test_save = "data/Output_Predictions_test_1M_movies(MLPwithGenres)/NNattr_TwoLayers_embed64_lr00003_batch64.csv")
...
b4 = run_program( 
                ...
                learningrate = 0.0003,
                embedding_length = 32,
                prediction_val_save = "data/Output_Predictions_val_1M_movies(MLPwithGenres)/NNattr_TwoLayers_embed32_lr00003_batch64.csv",
                prediction_test_save = "data/Output_Predictions_test_1M_movies(MLPwithGenres)/NNattr_TwoLayers_embed32_lr00003_batch64.csv")
...
b5 = run_program(
                ...
                learningrate = 0.001,
                embedding_length = 64,
                prediction_val_save = "data/Output_Predictions_val_1M_movies(MLPwithGenres)/NNattr_TwoLayers_embed64_lr0001_batch128.csv",
                prediction_test_save = "data/Output_Predictions_test_1M_movies(MLPwithGenres)/NNattr_TwoLayers_embed64_lr0001_batch128.csv")
...
b6 = run_program(
                ...
                learningrate = 0.001,
                embedding_length = 32,
                prediction_val_save = "data/Output_Predictions_val_1M_movies(MLPwithGenres)/NNattr_TwoLayers_embed32_lr0001_batch128.csv",
                prediction_test_save = "data/Output_Predictions_test_1M_movies(MLPwithGenres)/NNattr_TwoLayers_embed32_lr0001_batch128.csv")
...
b7 = run_program( 
                ...
                learningrate = 0.0003,
                embedding_length = 64,
                prediction_val_save = "data/Output_Predictions_val_1M_movies(MLPwithGenres)/NNattr_TwoLayers_embed64_lr00003_batch128.csv",
                prediction_test_save = "data/Output_Predictions_test_1M_movies(MLPwithGenres)/NNattr_TwoLayers_embed64_lr00003_batch128.csv")
...
b8 =  run_program( 
                ...
                learningrate = 0.0003,
                embedding_length = 32,
                prediction_val_save = "data/Output_Predictions_val_1M_movies(MLPwithGenres)/NNattr_TwoLayers_embed32_lr00003_batch128.csv",
                prediction_test_save = "data/Output_Predictions_test_1M_movies(MLPwithGenres)/NNattr_TwoLayers_embed32_lr00003_batch128.csv")
...
c1 = run_program( 
                ...
                learningrate = 0.001,
                embedding_length = 64,
                prediction_val_save = "data/Output_Predictions_val_1M_movies(MLPwithGenres)/NNattr_ThreeLayers_embed64_lr0001_batch64.csv",
                prediction_test_save = "data/Output_Predictions_test_1M_movies(MLPwithGenres)/NNattr_ThreeLayers_embed64_lr0001_batch64.csv")
...
c2 = run_program( 
                ...
                learningrate = 0.001,
                embedding_length = 32,
                prediction_val_save = "data/Output_Predictions_val_1M_movies(MLPwithGenres)/NNattr_ThreeLayers_embed32_lr0001_batch64.csv",
                prediction_test_save = "data/Output_Predictions_test_1M_movies(MLPwithGenres)/NNattr_ThreeLayers_embed32_lr0001_batch64.csv")
...
c3 = run_program( 
                ...
                learningrate = 0.0003,
                embedding_length = 64,
                prediction_val_save = "data/Output_Predictions_val_1M_movies(MLPwithGenres)/NNattr_ThreeLayers_embed64_lr00003_batch64.csv",
                prediction_test_save = "data/Output_Predictions_test_1M_movies(MLPwithGenres)/NNattr_ThreeLayers_embed64_lr00003_batch64.csv")
...
c4 = run_program( 
                ...
                learningrate = 0.0003,
                embedding_length = 32,
                prediction_val_save = "data/Output_Predictions_val_1M_movies(MLPwithGenres)/NNattr_ThreeLayers_embed32_lr00003_batch64.csv",
                prediction_test_save = "data/Output_Predictions_test_1M_movies(MLPwithGenres)/NNattr_ThreeLayers_embed32_lr00003_batch64.csv")
...
c5 = run_program(
                ...
                learningrate = 0.001,
                embedding_length = 64,
                prediction_val_save = "data/Output_Predictions_val_1M_movies(MLPwithGenres)/NNattr_ThreeLayers_embed64_lr0001_batch128.csv",
                prediction_test_save = "data/Output_Predictions_test_1M_movies(MLPwithGenres)/NNattr_ThreeLayers_embed64_lr0001_batch128.csv")
...
c6 = run_program(
                ...
                learningrate = 0.001,
                embedding_length = 32,
                prediction_val_save = "data/Output_Predictions_val_1M_movies(MLPwithGenres)/NNattr_ThreeLayers_embed32_lr0001_batch128.csv",
                prediction_test_save = "data/Output_Predictions_test_1M_movies(MLPwithGenres)/NNattr_ThreeLayers_embed32_lr0001_batch128.csv")
...
c7 = run_program( 
                ...
                learningrate = 0.0003,
                embedding_length = 64,
                prediction_val_save = "data/Output_Predictions_val_1M_movies(MLPwithGenres)/NNattr_ThreeLayers_embed64_lr00003_batch128.csv",
                prediction_test_save = "data/Output_Predictions_test_1M_movies(MLPwithGenres)/NNattr_ThreeLayers_embed64_lr00003_batch128.csv")
